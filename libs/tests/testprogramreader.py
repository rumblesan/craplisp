...
class Testprogramreader(unittest.TestCase):
    ...
    def test_char_commands(self):
        ...
        self.assertEqual("a", self.programreader.next())
        self.assertEqual("b", self.programreader.next())
        self.assertEqual("c", self.programreader.next())
        self.assertEqual("d", self.programreader.peek())
        self.assertEqual("d", self.programreader.peek())
        self.programreader.unnext()
        self.assertEqual("c", self.programreader.peek())
        self.assertEqual("c", self.programreader.next())
        self.assertEqual("d", self.programreader.next())
        self.assertEqual("e", self.programreader.next())
        self.assertEqual("f", self.programreader.next())
        self.assertEqual("g", self.programreader.next())
        self.assertEqual("", self.programreader.peek())
        self.assertEqual("", self.programreader.peek())
        self.assertEqual("", self.programreader.next())
        self.assertTrue(self.programreader.finished)
    ...
    def test_with_list(self):
        ...
        self.assertEqual(1, self.programreader.next())
        self.assertEqual(2, self.programreader.next())
        self.assertEqual(3, self.programreader.next())
